...
<head>
    ...
    <!-- MDB -->
    <link rel="stylesheet" href="<?php echo base_url('assets/cover/css/mdb.min.css')?>" />
    <!-- Custom styles -->
    <link rel="stylesheet" href="<?php echo base_url('assets/cover/css/style.css')?>'" />
</head>
<body>
      <!--Main Navigation-->
  <header>
    ...
    <?php
            ...
            <?php echo form_open_multipart('index.php/main/login-cover'); ?>
